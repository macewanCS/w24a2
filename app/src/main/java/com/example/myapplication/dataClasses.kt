...
data class TutoringSession(val date: String = "", val maxParticipants: Int = 0, val subjects: String = "", val time: String = "", val tutorID: String = "", val tutorName: String = "", val grades: String = "")